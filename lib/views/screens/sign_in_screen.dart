...
import '../../controller/helper_classes/user_role_helper.dart';
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: const [
                      ...
                      Text(
                        'Chào mừng đến với ứng dụng, hãy cung cấp \nemail và mật khẩu của bạn để đăng ký.',
                        style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            color: Colors.black),
                            ...
                            onPressed: () async {
                              if (SignInKey.currentState!.validate()) {
                                ...
                                if (res['error'] != null) {
                                  ...
                                  await UserRoleHelper.userRoleHelper
                                      .saveUserRole(
                                    email: email ?? '',
                                    role: 'user',
                                  );
