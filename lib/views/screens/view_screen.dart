            ...
            child: (id == 0)
                ...
                : RefreshIndicator(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, i) {
                          // Lấy category name từ viewCategory danh sách (id=0 là "All", id=1 là "Cây Ăn Quả", id=2 là "Cây lấy hạt")
                          String categoryName =
                              (id == 0) ? '' : viewCategory[id]['name'];
                          bool isMatched = (id == 0) ||
                              (AllProducts[i].category == categoryName);
