...
import 'package:ecommerce_app_firebase/views/screens/customer_info_screen.dart';
...
import 'package:ecommerce_app_firebase/views/screens/user_orders_page.dart';
import 'package:ecommerce_app_firebase/views/screens/admin_orders_page.dart';
import 'package:ecommerce_app_firebase/views/screens/user_info_screen.dart';
import 'package:ecommerce_app_firebase/views/screens/admin_statistics_page.dart';
import 'package:ecommerce_app_firebase/views/screens/admin_users_page.dart';
      ...
      builder: (context, child) {
        return GetMaterialApp(
          ...
          routes: {
            ...
            'userOrders': (context) => UserOrdersPage(),
            'adminOrders': (context) => AdminOrdersPage(),
            'userInfo': (context) => UserInfoScreen(),
            'customerInfo': (context) => CustomerInfoScreen(),
